...
{
  hdr->pcp_cfi_vid = (hdr->pcp_cfi_vid & ~OPENVPN_8021Q_MASK_CFI) | (pcp & OPENVPN_8021Q_MASK_CFI);
}
/*
...
{
  hdr->pcp_cfi_vid = (hdr->pcp_cfi_vid & ~OPENVPN_8021Q_MASK_CFI) | (vid & OPENVPN_8021Q_MASK_CFI);
}
#endif
